...
namespace coreneuron {
    ...
    inline double fibonacci_recursion(int id, int pnodecount, recursion_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_n);


    inline double fibonacci_recursion(int id, int pnodecount, recursion_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_n) {
        double ret_fibonacci = 0.0;
        if (_arg_n == 0.0 || _arg_n == 1.0) {
            ret_fibonacci = 1.0;
        } else {
            ret_fibonacci = fibonacci_recursion(id, pnodecount, inst, data, indexes, thread, nt, v, _arg_n - 1.0) + fibonacci_recursion(id, pnodecount, inst, data, indexes, thread, nt, v, _arg_n - 2.0);
        }
