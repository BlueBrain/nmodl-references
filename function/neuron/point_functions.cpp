...
namespace neuron {
    ...
    static point_functions_Store point_functions_global;
    ...
    static void nrn_destructor_point_functions(Prop* prop);
    ...
    static double _hoc_x_plus_a(void * _vptr) {
        ...
        auto inst = make_instance_point_functions(_p ? &_lmc : nullptr);
    ...
    static void nrn_init_point_functions(const _nrn_model_sorted_token& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
    ...
    static void nrn_destructor_point_functions(Prop* prop) {
        ...
        const size_t id = 0;
        auto inst = make_instance_point_functions(prop ? &_lmc : nullptr);
    ...
    extern "C" void _point_functions_reg() {
        ...
        _pointtype = point_register_mech(mechanism_info, nrn_alloc_point_functions, nullptr, nullptr, nullptr, nrn_init_point_functions, -1, 1, _hoc_create_pnt, _hoc_destroy_pnt, _member_func);
