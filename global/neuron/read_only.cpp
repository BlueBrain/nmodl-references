...
namespace neuron {
    ...
    struct read_only_Instance  {
        double* x{};
        double* Dx{};
        double* v_unused{};
        double* g_unused{};
        read_only_Store* global{&read_only_global};
    };


    struct read_only_NodeData  {
    ...
    static read_only_Instance make_instance_read_only(_nrn_mechanism_cache_range& _ml) {
    ...
    static read_only_NodeData make_node_data_read_only(NrnThread& _nt, Memb_list& _ml_arg) {
    ...
    static DoubScal hoc_scalar_double[] = {
        {"c_read_only", &read_only_global.c},
        {nullptr, nullptr}
    };
    ...
    static VoidFunc hoc_intfunc[] = {
        {"setdata_read_only", _hoc_setdata},
        {nullptr, nullptr}
    };
    ...
    void nrn_init_read_only(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_read_only(_lmr);
        auto node_data = make_node_data_read_only(*_nt, *_ml_arg);
    ...
    void nrn_state_read_only(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_read_only(_lmr);
        auto node_data = make_node_data_read_only(*_nt, *_ml_arg);
        auto nodecount = _ml_arg->nodecount;
    ...
    static void nrn_jacob_read_only(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_read_only(_lmr);
        auto node_data = make_node_data_read_only(*_nt, *_ml_arg);
        auto nodecount = _ml_arg->nodecount;
