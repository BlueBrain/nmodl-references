...
namespace neuron {
    ...
    inline double vtrap_hodhux(_nrn_mechanism_cache_range& _lmc, hodhux_Instance& inst, size_t id, Datum* _ppvar, Datum* _thread, NrnThread* nt, double _arg_x, double _arg_y);
    ...
    inline int rates_hodhux(_nrn_mechanism_cache_range& _lmc, hodhux_Instance& inst, size_t id, Datum* _ppvar, Datum* _thread, NrnThread* nt, double _arg_v);
    ...
    inline int rates_hodhux(_nrn_mechanism_cache_range& _lmc, hodhux_Instance& inst, size_t id, Datum* _ppvar, Datum* _thread, NrnThread* nt, double _arg_v) {
        ...
        tinc =  -nt->_dt * q10;
        alpha = .1 * vtrap_hodhux(_lmc, inst, id, _ppvar, _thread, nt,  -(_arg_v + 40.0), 10.0);
        ...
        alpha = .01 * vtrap_hodhux(_lmc, inst, id, _ppvar, _thread, nt,  -(_arg_v + 55.0), 10.0);
