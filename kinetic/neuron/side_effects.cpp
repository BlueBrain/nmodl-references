...
namespace neuron {
    ...
    static void ode_spec_side_effects(_nrn_model_sorted_token const& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
    ...
    static void ode_matsol_side_effects(_nrn_model_sorted_token const& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmc{_sorted_token, *nt, *_ml_arg, _type};
        auto inst = make_instance_side_effects(_lmc);
        auto nodecount = _ml_arg->nodecount;
        auto node_data = make_node_data_side_effects(*nt, *_ml_arg);
