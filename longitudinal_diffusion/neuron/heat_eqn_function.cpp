...
namespace neuron {
    ...
    static void ode_setup_tolerance_heat_eqn_function(Prop* _prop, int equation_index, neuron::container::data_handle<double>* _pv, neuron::container::data_handle<double>* _pvdot, double* _atol, int _type) {
    ...
    extern "C" void _heat_eqn_function_reg() {
        ...
        hoc_register_cvode(mech_type, ode_count_heat_eqn_function, ode_setup_tolerance_heat_eqn_function, ode_setup_nonstiff_heat_eqn_function, ode_setup_stiff_heat_eqn_function);
