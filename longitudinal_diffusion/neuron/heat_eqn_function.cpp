...
namespace neuron {
    ...
    static int ode_update_stiff_heat_eqn_function(_nrn_mechanism_cache_range& _lmc, heat_eqn_function_Instance& inst, heat_eqn_function_NodeData& node_data, size_t id, Datum* _ppvar, Datum* _thread, NrnThread* nt, heat_eqn_function_ThreadVariables& _thread_vars) {
        auto v = node_data.node_voltages ? node_data.node_voltages[node_data.nodeindices[id]] : 0.0;
        double source0_;
        ;
        source0_ = 0.0;
