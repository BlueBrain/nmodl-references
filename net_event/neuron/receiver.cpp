...
namespace neuron {
    ...
    static receiver_Instance make_instance_receiver(_nrn_mechanism_cache_range& _ml) {
    ...
    static receiver_NodeData make_node_data_receiver(NrnThread& _nt, Memb_list& _ml_arg) {
    ...
    void nrn_init_receiver(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_receiver(_lmr);
        auto node_data = make_node_data_receiver(*_nt, *_ml_arg);
    ...
    static void nrn_jacob_receiver(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_receiver(_lmr);
        auto node_data = make_node_data_receiver(*_nt, *_ml_arg);
        auto nodecount = _ml_arg->nodecount;
    ...
    static void nrn_net_receive_receiver(Point_process* _pnt, double* _args, double _lflag) {
        ...
        auto inst = make_instance_receiver(_ml_obj);
        size_t id = 0;
        double t = _nt->_t;
