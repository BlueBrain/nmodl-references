...
namespace neuron {
    ...
    static spiker_Instance make_instance_spiker(_nrn_mechanism_cache_range& _ml) {
    ...
    void nrn_init_spiker(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_spiker(_lmr);
    ...
    static void nrn_jacob_spiker(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_spiker(_lmr);
        auto node_data = make_node_data_spiker(*_nt, *_ml_arg);
        auto nodecount = _ml_arg->nodecount;
    ...
    static void nrn_net_receive_spiker(Point_process* _pnt, double* _args, double _lflag) {
        ...
        auto inst = make_instance_spiker(_ml_obj);
        size_t id = 0;
        double t = _nt->_t;
        double tt;
        tt = inst.tnext[id];
