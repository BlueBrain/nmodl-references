...
namespace neuron {
    ...
    static art_toggle_Instance make_instance_art_toggle(_nrn_mechanism_cache_range& _ml) {
    ...
    static art_toggle_NodeData make_node_data_art_toggle(NrnThread& _nt, Memb_list& _ml_arg) {
