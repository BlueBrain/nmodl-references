...
namespace neuron {
    ...
    static test_parameter_Instance make_instance_test_parameter(_nrn_mechanism_cache_range& _ml) {
    ...
    static test_parameter_NodeData make_node_data_test_parameter(NrnThread& _nt, Memb_list& _ml_arg) {
    ...
    static void nrn_alloc_test_parameter(Prop* _prop) {
        Prop *prop_ion{};
        Datum *_ppvar{};
        if (nrn_point_prop_) {
    ...
    void nrn_init_test_parameter(const _nrn_model_sorted_token& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
    ...
    static void nrn_jacob_test_parameter(const _nrn_model_sorted_token& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_test_parameter(_lmr);
        auto node_data = make_node_data_test_parameter(*_nt, *_ml_arg);
        auto nodecount = _ml_arg->nodecount;
