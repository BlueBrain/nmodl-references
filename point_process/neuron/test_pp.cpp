...
namespace neuron {
    ...
    static void nrn_alloc_test_pp(Prop* _prop) {
        Prop *prop_ion{};
        Datum *_ppvar{};
        if (nrn_point_prop_) {
    ...
    void nrn_init_test_pp(const _nrn_model_sorted_token& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
    ...
    static void nrn_jacob_test_pp(const _nrn_model_sorted_token& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_test_pp(_lmr);
        auto node_data = make_node_data_test_pp(*_nt, *_ml_arg);
        auto nodecount = _ml_arg->nodecount;
    ...
    extern "C" void _test_pp_reg() {
        _initlists();

        _pointtype = point_register_mech(mechanism_info, nrn_alloc_test_pp, nullptr, nullptr, nullptr, nrn_init_test_pp, hoc_nrnpointerindex, 1, _hoc_create_pnt, _hoc_destroy_pnt, _member_func);
