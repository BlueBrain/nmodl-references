...
namespace coreneuron {
    ...
    inline double identity_procedures(int id, int pnodecount, procedures_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_v);
    ...
    inline int set_x_a_procedures(int id, int pnodecount, procedures_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_a);
    ...
    inline int set_x_just_vv_procedures(int id, int pnodecount, procedures_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_v);
    ...
    inline int set_x_just_vv_procedures(int id, int pnodecount, procedures_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_v) {
        ...
        inst->x[id] = identity_procedures(id, pnodecount, inst, data, indexes, thread, nt, v, _arg_v);
