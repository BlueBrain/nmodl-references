...
namespace neuron {
    ...
    static point_procedures_NodeData make_node_data_point_procedures(NrnThread& _nt, Memb_list& _ml_arg) {
    ...
    void nrn_init_point_procedures(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
    ...
    static void nrn_jacob_point_procedures(_nrn_model_sorted_token const& _sorted_token, NrnThread* _nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmr{_sorted_token, *_nt, *_ml_arg, _type};
        auto inst = make_instance_point_procedures(_lmr);
        auto node_data = make_node_data_point_procedures(*_nt, *_ml_arg);
        auto nodecount = _ml_arg->nodecount;
