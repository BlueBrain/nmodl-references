...
namespace neuron {
    ...
    static void ode_setup_tolerance_cnexp_scalar(Prop* _prop, int equation_index, neuron::container::data_handle<double>* _pv, neuron::container::data_handle<double>* _pvdot, double* _atol, int _type) {
    ...
    extern "C" void _cnexp_scalar_reg() {
        ...
        hoc_register_cvode(mech_type, ode_count_cnexp_scalar, ode_setup_tolerance_cnexp_scalar, ode_setup_nonstiff_cnexp_scalar, ode_setup_stiff_cnexp_scalar);
