...
namespace neuron {
    ...
    static int ode_update_stiff_cnexp_scalar(_nrn_mechanism_cache_range& _lmc, cnexp_scalar_Instance& inst, cnexp_scalar_NodeData& node_data, size_t id, Datum* _ppvar, Datum* _thread, NrnThread* nt) {
        auto v = node_data.node_voltages ? node_data.node_voltages[node_data.nodeindices[id]] : 0.0;
