...
namespace neuron {
    ...
    struct derivimplicit_array_NodeData  {
    ...
    static derivimplicit_array_NodeData make_node_data_derivimplicit_array(NrnThread& nt, Memb_list& _ml_arg) {
    ...
    void nrn_destructor_derivimplicit_array(Prop* _prop) {
    ...
    static constexpr int ode_count_derivimplicit_array(int _type) {
        return 1;
    }
    static void ode_spec_derivimplicit_array(_nrn_model_sorted_token const& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
    ...
    static void ode_map_derivimplicit_array(Prop* _prop, int equation_index, neuron::container::data_handle<double>* _pv, neuron::container::data_handle<double>* _pvdot, double* _atol, int _type) {
    ...
    static void ode_matsol_derivimplicit_array(_nrn_model_sorted_token const& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmc{_sorted_token, *nt, *_ml_arg, _type};
        auto inst = make_instance_derivimplicit_array(_lmc);
        auto nodecount = _ml_arg->nodecount;
        auto node_data = make_node_data_derivimplicit_array(*nt, *_ml_arg);
    ...
    struct functor_derivimplicit_array_0 {
        ...
        functor_derivimplicit_array_0(_nrn_mechanism_cache_range& _lmc, derivimplicit_array_Instance& inst, size_t id, Datum* _ppvar, Datum* _thread, NrnThread* nt, double v)
        ...
        void operator()(const Eigen::Matrix<double, 1, 1>& nmodl_eigen_xm, Eigen::Matrix<double, 1, 1>& nmodl_eigen_fm, Eigen::Matrix<double, 1, 1>& nmodl_eigen_jm) const {
            ...
            nmodl_eigen_f[static_cast<int>(0)] = nmodl_eigen_x[static_cast<int>(0)] * nt->_dt * (inst.s+id*2)[static_cast<int>(0)] * (inst.z+id*3)[static_cast<int>(0)] * (inst.z+id*3)[static_cast<int>(1)] * (inst.z+id*3)[static_cast<int>(2)] + nmodl_eigen_x[static_cast<int>(0)] * nt->_dt * (inst.s+id*2)[static_cast<int>(1)] * (inst.z+id*3)[static_cast<int>(0)] * (inst.z+id*3)[static_cast<int>(1)] * (inst.z+id*3)[static_cast<int>(2)] - nmodl_eigen_x[static_cast<int>(0)] + old_x;
            nmodl_eigen_j[static_cast<int>(0)] = nt->_dt * (inst.s+id*2)[static_cast<int>(0)] * (inst.z+id*3)[static_cast<int>(0)] * (inst.z+id*3)[static_cast<int>(1)] * (inst.z+id*3)[static_cast<int>(2)] + nt->_dt * (inst.s+id*2)[static_cast<int>(1)] * (inst.z+id*3)[static_cast<int>(0)] * (inst.z+id*3)[static_cast<int>(1)] * (inst.z+id*3)[static_cast<int>(2)] - 1.0;
        }
    ...
    static VoidFunc hoc_intfunc[] = {
        {"setdata_derivimplicit_array", _hoc_setdata},
        {nullptr, nullptr}
    };
    ...
    void nrn_state_derivimplicit_array(const _nrn_model_sorted_token& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
        ...
        for (int id = 0; id < nodecount; id++) {
            ...
            // call newton solver
            functor_derivimplicit_array_0 newton_functor(_lmc, inst, id, _ppvar, _thread, nt, v);
    ...
    extern "C" void _derivimplicit_array_reg() {
        ...
        register_mech(mechanism_info, nrn_alloc_derivimplicit_array, nullptr, nrn_jacob_derivimplicit_array, nrn_state_derivimplicit_array, nrn_init_derivimplicit_array, hoc_nrnpointerindex, 1);
        ...
        hoc_register_cvode(mech_type, ode_count_derivimplicit_array, ode_map_derivimplicit_array, ode_spec_derivimplicit_array, ode_matsol_derivimplicit_array);
