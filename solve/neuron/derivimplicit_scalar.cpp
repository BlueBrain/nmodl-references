...
namespace neuron {
    ...
    static int ode_count_derivimplicit_scalar(int _type) {
        return 1;
    }
    static void ode_spec_derivimplicit_scalar(_nrn_model_sorted_token const& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
    ...
    static void ode_matsol_derivimplicit_scalar(_nrn_model_sorted_token const& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
        _nrn_mechanism_cache_range _lmc{_sorted_token, *nt, *_ml_arg, _type};
        auto inst = make_instance_derivimplicit_scalar(_lmc);
        auto nodecount = _ml_arg->nodecount;
        auto node_data = make_node_data_derivimplicit_scalar(*nt, *_ml_arg);
