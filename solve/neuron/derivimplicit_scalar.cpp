...
namespace neuron {
    ...
    static void ode_setup_tolerances_derivimplicit_scalar(Prop* _prop, int equation_index, neuron::container::data_handle<double>* _pv, neuron::container::data_handle<double>* _pvdot, double* _atol, int _type) {
    ...
    static int ode_update_stiff_derivimplicit_scalar(_nrn_mechanism_cache_range& _lmc, derivimplicit_scalar_Instance& inst, derivimplicit_scalar_NodeData& node_data, size_t id, Datum* _ppvar, Datum* _thread, NrnThread* nt) {
        auto v = node_data.node_voltages ? node_data.node_voltages[node_data.nodeindices[id]] : 0.0;
    ...
    struct functor_derivimplicit_scalar_0 {
        ...
        functor_derivimplicit_scalar_0(_nrn_mechanism_cache_range& _lmc, derivimplicit_scalar_Instance& inst, derivimplicit_scalar_NodeData& node_data, size_t id, Datum* _ppvar, Datum* _thread, NrnThread* nt)
    ...
    static void nrn_state_derivimplicit_scalar(const _nrn_model_sorted_token& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
        ...
        for (int id = 0; id < nodecount; id++) {
            ...
            // call newton solver
            functor_derivimplicit_scalar_0 newton_functor(_lmc, inst, node_data, id, _ppvar, _thread, nt);
    ...
    static void nrn_destructor_derivimplicit_scalar(Prop* prop) {
        ...
        const size_t id = 0;
        auto inst = make_instance_derivimplicit_scalar(prop ? &_lmc : nullptr);
    ...
    extern "C" void _derivimplicit_scalar_reg() {
        ...
        hoc_register_cvode(mech_type, ode_count_derivimplicit_scalar, ode_setup_tolerances_derivimplicit_scalar, ode_setup_nonstiff_derivimplicit_scalar, ode_setup_stiff_derivimplicit_scalar);
