...
namespace coreneuron {
    ...
    inline static double forty_three_nothing(int id, int pnodecount, nothing_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v);


    inline double forty_three_nothing(int id, int pnodecount, nothing_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v) {
    ...
    void _suffix_nothing_again_reg() {
