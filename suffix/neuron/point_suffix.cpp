...
namespace neuron {
    ...
    static point_suffix_NodeData make_node_data_point_suffix(NrnThread& nt, Memb_list& _ml_arg) {
    ...
    void nrn_destructor_point_suffix(Prop* _prop) {
    ...
    void nrn_init_point_suffix(const _nrn_model_sorted_token& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
