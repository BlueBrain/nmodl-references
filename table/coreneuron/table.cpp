...
namespace coreneuron {
    ...
    inline double quadratic_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_x);
    inline int sigmoidal_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_v);
    inline int sinusoidal_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_x);


    inline int f_sigmoidal_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_v) {
    ...
    inline int sigmoidal_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_v){
        if (inst->global->usetable == 0) {
            f_sigmoidal_tbl(id, pnodecount, inst, data, indexes, thread, nt, v, _arg_v);
            return 0;
        }
    ...
    inline int f_sinusoidal_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_x) {
    ...
    inline int sinusoidal_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_x){
        if (inst->global->usetable == 0) {
            f_sinusoidal_tbl(id, pnodecount, inst, data, indexes, thread, nt, v, _arg_x);
            return 0;
        }
    ...
    inline double f_quadratic_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_x) {
    ...
    inline double quadratic_tbl(int id, int pnodecount, tbl_Instance* inst, double* data, const Datum* indexes, ThreadDatum* thread, NrnThread* nt, double v, double _arg_x){
        if (inst->global->usetable == 0) {
            return f_quadratic_tbl(id, pnodecount, inst, data, indexes, thread, nt, v, _arg_x);
        }
