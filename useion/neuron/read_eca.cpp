...
namespace neuron {
    ...
    struct read_eca_Instance  {
        ...
        double* eca{};
        double* v_unused{};
        const double* const* ion_eca{};
        read_eca_Store* global{&read_eca_global};
    };


    struct read_eca_NodeData  {
    ...
    static read_eca_NodeData make_node_data_read_eca(NrnThread& nt, Memb_list& _ml_arg) {
    ...
    void nrn_init_read_eca(const _nrn_model_sorted_token& _sorted_token, NrnThread* nt, Memb_list* _ml_arg, int _type) {
    ...
    extern "C" void _read_eca_reg() {
        ...
        register_mech(mechanism_info, nrn_alloc_read_eca, nullptr, nullptr, nullptr, nrn_init_read_eca, -1, 1);
        ...
        hoc_register_prop_size(mech_type, 3, 1);
